...
PresidentialPardonForm::PresidentialPardonForm(const PresidentialPardonForm &src) : AForm("PresidentialPardonForm", src.getSignGrade(), src.getExecuteGrade(), src._target){}
